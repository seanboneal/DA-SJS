...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
1.  Explore the distribution of `price`. Do you discover anything
    unusual or surprising? (Hint: Carefully think about the `binwidth`
    and make sure you try a wide range of values.)

2.  How many diamonds are 0.99 carat? How many are 1 carat? What do you
    think is the cause of the difference?
    
    ’

3.  Compare and contrast `coord_cartesian()` vs `xlim()` or `ylim()`
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
``` r
ggplot(diamonds, aes(x = carat, y = price)) + geom_point(alpha = .5)
```

![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
<img src="Data-exploration-notebook_files/figure-gfm/unnamed-chunk-35-1.png" width="50%" />
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
![](Data-exploration-notebook_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
